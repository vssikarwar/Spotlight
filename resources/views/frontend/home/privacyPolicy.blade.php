...
<section style="padding: 140px 0 50px;">
    <div class="container">
        ...
        <div style="padding-left: 40px;">
            ...
            <h4>5. Third - Party Tracking</h4>
            <p>We may use third-party service providers to serve advertisements on our behalf across the Internet. These service providers may collect your IP address and non-personally identifiable or de-identified information about your visits to the Site in order to serve ads while you are visiting other web sites. Such non-personally identifiable information is anonymous or de-identified and does not reflect your name, address, e-mail address or other personal information; however your IP address may be collected by such services. This anonymous or de-identified information is often collected through the use of a web beacon, which is industry-standard technology used by most major websites.</p></div>
                ...
                <div class="col-md-12">
                    <div class="footer-left-wr">
                        <div class="footer-logo">
                            <img src="/frontend/img/logo_w.png" alt="spotlight" class="foot_logo"/>                        </div>
...
</footer>        <script>var urlForJs = "https://testing.myspotlight.co/";</script>
        <script src="/frontend/js/jquery-3.1.1.min.js">

        </script><script src="/frontend/js/bootstrap.min.js">

        </script><script src="/frontend/js/popper.min.js">

        </script><script src="/frontend/js/slick.min.js">

        </script><script src="/frontend/js/jquery.waypoints.min.js">

        </script><script src="/frontend/js/jquery.counterup.min.js">

        </script><script src="/frontend/js/wow.min.js">

        </script><script src="/frontend/js/magnific-popup.min.js">

        </script><script src="/frontend/js/common.js?q=60820317">

        </script><script src="/frontend/js/main.js?q=60820317">

        </script><script src="/frontend/js/form.submit.js?q=60820317">

        </script><script src="https://www.google.com/recaptcha/api.js?q=60820317">
